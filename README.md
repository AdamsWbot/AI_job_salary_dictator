...
<details>
<summary><b>company_size（公司规模）</b></summary>

| 索引 | 类别 | 样本数 |
|---|---|---|
| 0 | Startup (1-50) | 292 |
| 1 | Enterprise (5000+) | 296 |
| 2 | Big Tech (FAANG+) | 299 |
| 3 | SME (51-500) | 300 |
| 4 | Mid-size (501-5000) | 312 |
...
**Q: 为什么 remote_work（办公模式）没有用于训练？**
A: 办公模式与年薪的相关性可能被其他特征（如国家、公司规模、行业）更好地捕捉。去除它可以减少特征维度，降低多重共线性风险。
